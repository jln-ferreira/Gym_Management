<template>
  <div id="app">
    ...
    <nav id="navbar" class="navbar navbar-expand-sm navbar-dark fixed-top">
      <div class="container">
        <a class="navbar-brand" href="#"><img src="image/LogoHorizontal.png" alt="logo" width="120"></a>
        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item">
              <a class="nav-link" href="#upcommingevents">Upcoming Events</a>
            </li>
            <li class="nav-item">
    ...
    <!------------ END carousel  ------>
    <!------------ upcomingEvents  ---->
    <upcomingEvents id="upcommingevents"/>
    <!------------ END upcomingEvents -->
    <!------------ CONTACT  ---------->
    <contact id="contact"/>
    <!------------ END CONTACT  ------>
